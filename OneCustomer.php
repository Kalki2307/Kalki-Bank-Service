...
$username = "sumit";
$password = "Qwerty123@";
$con = new mysqli("localhost", "sumit", "Qwerty123@", "sumit");
if (!$con) {
...
<body>
  <header>
    ...
    <div class="img">
      <img src="17.png" style=" height: 250px;"></img>
    </div>
    <div class="trans" style="padding-right: 0rem; padding-left:60rem;margin-top: -22rem;text-decoration: bold;">
      ...
      <form action="transfer.php" method="POST">
        ...
        <select name="reciever" id="dropdown" class="textbox" required>
          ...
          <?php
          //todo
          $db = new mysqli("localhost", "sumit", "Qwerty123@", "sumit");
        ...
        <br><br>
        <br></br>
        <a href="home.php"><button id="transfer" name="transfer" ;>Transfer</button></a>
